...
def get_ip_data():
    ...
    input_status = input("What is the status of this device? ")
    input_restore = input("Restore device if inactive? ")
    d = {"IP": input_ip, "driver": input_driver, "status" : input_status, "restore" : input_restore}
    return d
