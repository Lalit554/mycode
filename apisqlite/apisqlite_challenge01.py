...
def movielookup(mykey, searchstring, searchtype=""):
...
def get_type(mykey,searchstring):
    mtype = ""
    while mtype not in type:
        print("Searchable program types:",*type,sep="\n")
        mtype=input("Choose program type:").lower()
    resp = movielookup(mykey, searchstring, mtype)
    return resp
    ...
    while True:
        ...
        if answer in ["1", "2"]:
            ...
            if answer == "1":
                ...
                resp = get_type(mykey,searchstring)
